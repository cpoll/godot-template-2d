...
# Vendored notes
- Instead of the installation guide, which depends on plugin.gd (not vendored), we manually add
an autoload singleton named Multiplayer Output
(equivalent to `add_autoload_singleton("MultiplayerInput", "res://addons/multiplayer_input/multiplayer_input.gd")`)
